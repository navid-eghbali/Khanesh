...
import khanesh.feature.books.navigation.BooksRouter.navigateToBooks
import khanesh.feature.books.navigation.booksGraph
    ...
    Scaffold(
        ...
        NavHost(
            ...
            homeGraph(
                ...
                onGenreClicked = { navController.navigateToBooks(it) },
            )
            exploreGraph(
